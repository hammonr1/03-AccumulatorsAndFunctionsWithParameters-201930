...
#            ruth_window = rg.RoseWindow(300, 300)
#
...
#            ruth_window = rg.RoseWindow(300, 100)
#
...
#               It only redraws the graphics when several pixels have changed rather than every pixel.

#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            The window closing needs to be determined by the user
#
